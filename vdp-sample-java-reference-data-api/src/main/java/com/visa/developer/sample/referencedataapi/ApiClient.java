...
import com.visa.developer.sample.referencedataapi.auth.OAuth;
...
public class ApiClient {
  ...
  public ApiClient(Authentication authentication) {
    ...
    // Setup authentications (key: authentication name, value: authentication). mutualAuth
    ...
    throw new IllegalArgumentException("Invalid Auth Method");
    }
  ...
  public ApiClient rebuildHttpClient() {
    ...
    if(authentications.containsKey("mutualAuth")){
      HttpBasicAuth basicAuth =  (HttpBasicAuth) authentications.get("mutualAuth");
      if(basicAuth != null && basicAuth.getUsername() != null && !basicAuth.getUsername().isEmpty()) {
        conf.getProperties().put(com.sun.jersey.client.urlconnection.HTTPSProperties.PROPERTY_HTTPS_PROPERTIES, new com.sun.jersey.client.urlconnection.HTTPSProperties(basicAuth.getHostnameVerifier(), basicAuth.getSSLContext()));
      }
    }
  ...
  private ClientResponse getAPIResponse(String path, String resourcePath, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String accept, String contentType, String[] authNames) throws ApiException {
    if (body != null && !formParams.isEmpty()) {
      throw new ApiException(500, "Cannot have body and form params");
    }

    updateParamsForAuth(resourcePath, body, authNames, queryParams, headerParams);
   ...
   * @throws ApiException API exception
   */
   public <T> T invokeAPI(String path, String resourcePath, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String accept, String contentType, String[] authNames, GenericType<T> returnType) throws ApiException {

    ClientResponse response = getAPIResponse(path, resourcePath, method, queryParams, body, headerParams, formParams, accept, contentType, authNames);

    statusCode = response.getStatusInfo().getStatusCode();
    responseHeaders = response.getHeaders();

    boolean get404 = (path.contains("mvisa") || path.contains("fundstransfer")) && method == "GET";

    if(response.getStatusInfo().getStatusCode() == ClientResponse.Status.NO_CONTENT.getStatusCode() || (get404 && response.getStatusInfo().getFamily() == Family.CLIENT_ERROR) || (response.getStatusInfo().getFamily() == Family.REDIRECTION)) {
      return null;
   ...
   */
  private void updateParamsForAuth(String resourcePath, Object body, String[] authNames, List<Pair> queryParams,
			Map<String, String> headerParams) {
    for (String authName : authNames) {
      Authentication auth = authentications.get(authName);
      if (auth == null) throw new RuntimeException("Authentication undefined: " + authName);
      auth.applyToParams(resourcePath, body, headerParams,queryParams);
    }
  }
